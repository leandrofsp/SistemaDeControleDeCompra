...
function setList(list){
	...
	for (var keys in list){
		table += '<tr><td>'+ formatDesc(list[keys].desc) +'</td><td>'+ list[keys].amount +'</td><td> '+ formatValue(list[keys].value) +'</td><td> <button class="btn btn-default" onclick="setUpdate('+keys+');"> Edit </button> | Delete</td>';
	}
	table += '</tbody>';
